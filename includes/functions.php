...
{
    if (empty($args)) {
        return \Idyll\I18n::translate($string);
    } else {
        return vsprintf(\Idyll\I18n::translate($string), $args);
    }
}
...
{
    return \Idyll\Request::instance()->getUrlPrefix() . '/index.php/' . $uri;
}
...
{
    return \Idyll\Request::instance()->getUrlPrefix() . '/' . $uri;
}
